...
COMMENT ON WAREHOUSE learn_wh IS
'Auto-suspend after 60 seconds helps avoid unnecessary compute usage and conserve the $400 free-trial credit budget.';
...
CREATE DATABASE retail_lakehouse;
CREATE SCHEMA retail_lakehouse.bronze;